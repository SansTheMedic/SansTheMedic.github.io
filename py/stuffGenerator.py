...
def getDocData(DocName):
    ...
    preview_path = ("C:\\Users\\Jack.NEWT\\Documents\\GitHub\\SansTheMedic.github.io\\pages\\stuffDocs\\previews\\" + DocName + ".txt")
...
def WriteToStuffPage(HtmlContent):
    ...
    with open("C:\\Users\\Jack.NEWT\\Documents\\GitHub\\SansTheMedic.github.io\\pages\\stuff.html", "w") as blog_page:
...
def getFiles():
    ...
    document_files = [name for name in os.listdir('C:\\Users\\Jack.NEWT\\Documents\\GitHub\\SansTheMedic.github.io\\pages\\stuffDocs')]

    # Gets all image files
    image_files = [name for name in os.listdir('C:\\Users\\Jack.NEWT\\Documents\\GitHub\\SansTheMedic.github.io\\images\\stuffImages')]
